...
public class Grocery extends AppCompatActivity {
    ArrayList<TabItem> mTableItemList;
    class TabItem {
        //正常情况下显示的图片
    ...
    private void initTabData() {
        ...
        //添加tab
        mTableItemList.add(new TabItem(R.drawable.main_bottom_home_normal,R.drawable.main_bottom_home_press,R.string.main_home_text, Frag_Grocery_Home.class));
        mTableItemList.add(new TabItem(R.drawable.main_bottom_search_normal,R.drawable.main_bottom_search_press,R.string.main_search_text, Frag_Grocery_Search.class));
        mTableItemList.add(new TabItem(R.drawable.main_bottom_discover_normal,R.drawable.main_bottom_discover_press,R.string.main_discover_text, Frag_Grocery_Browse.class));
        mTableItemList.add(new TabItem(R.drawable.main_bottom_discount_normal,R.drawable.main_bottom_discount_press,R.string.main_discount_text, Frag_Grocery_Browse.class));
        mTableItemList.add(new TabItem(R.drawable.main_bottom_list_normal,R.drawable.main_bottom_list_press,R.string.main_list_text, Frag_Grocery_Browse.class));
